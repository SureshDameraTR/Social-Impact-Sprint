...
from app.services.milk_pricing import FAT_SLABS, SNF_SLABS, _get_slab_rate, calculate_rate
...
class TestCalculateRate:
    ...
    def test_known_calculation(self):
        ...
        rate = (4.0 * 8.50 + 8.5 * 6.00) / 2 = (34.0 + 51.0) / 2 = 42.50
        """
        rate = calculate_rate(4.0, 8.5)
    ...
    def test_high_fat_buffalo_milk(self):
        ...
        # (7.0 * 11.00 + 9.0 * 7.00) / 2 = (77 + 63) / 2 = 70.00
        assert rate == Decimal("70.00")
    ...
    def test_low_fat_low_snf(self):
        ...
        # (3.0 * 7.50 + 8.0 * 5.00) / 2 = (22.5 + 40.0) / 2 = 31.25
