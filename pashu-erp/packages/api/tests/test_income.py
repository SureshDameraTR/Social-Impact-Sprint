...
class TestIncomeSummary:
    ...
    async def test_summary_other_user_forbidden(self, client: AsyncClient) -> None:
...
class TestMyIncomeSummary:
    async def test_my_summary_success(self, client: AsyncClient, mock_db: AsyncMock) -> None:
...
class TestIncomeBreakdown:
    async def test_breakdown_success(self, client: AsyncClient, mock_db: AsyncMock) -> None:
    ...
    async def test_breakdown_other_user_forbidden(self, client: AsyncClient) -> None:
...
class TestMyTransactions:
    async def test_transactions_success(self, client: AsyncClient, mock_db: AsyncMock) -> None:
...
class TestIncomeByCategory:
    async def test_by_category_success(self, client: AsyncClient, mock_db: AsyncMock) -> None:
        """GET returns 200."""
        txn_result = MagicMock()
        txn_result.all.return_value = []
        sell_result = MagicMock()
...
class TestMonthlyTrend:
    async def test_monthly_success(self, client: AsyncClient, mock_db: AsyncMock) -> None:
        """GET returns 200."""
        txn_result = MagicMock()
        txn_result.all.return_value = []
        sell_result = MagicMock()
